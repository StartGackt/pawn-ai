...
import { Send, Sparkles, TrendingUp, BarChart3, FileText, MessageSquare } from "lucide-react";
...
const exampleQuestions = [
    ...
    "อัตราดอกเบี้ยรับจำนำของสำนักงานธนานุเคราะห์เป็นอย่างไร?",
    "การประเมินราคาทองคำรูปพรรณมีหลักเกณฑ์อย่างไร?",
    "ขั้นตอนการไถ่ถอนทรัพย์สินเป็นอย่างไร?",
    "ทรัพย์หลุดจำนำสามารถซื้อได้ที่ไหน?",
];
        ...
        const fetchModels = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    // Models fetched but not currently displayed in UI
